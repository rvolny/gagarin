      ...
      <row class="mt-5 align-items-center justify-content-center">
        <column md="6">
          <form @submit="onSubmit" @reset="onReset" novalidate v-if="showForm">
            ...
            <div class="grey-text">
              <mdb-input-custom v-model="form.name" name="name" :label="$t('message.registration.labelName')"
              ...
              <mdb-input-custom v-model="form.password" name="password"
                                :label="$t('message.registration.labelPassword')" icon="lock" type="password" required
                                v-validate="'required|min:6'" ref="confirmation"
                                :validation-error="errors.first('password')"/>

              <mdb-input-custom v-model="form.passwordConfirmation" name="passwordConfirmation"
                                :label="$t('message.registration.labelPasswordConfirmation')"
                                icon="exclamation-triangle" type="password" required
